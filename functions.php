			...
			<form method="post" action="options.php">
				...
				<div class="stylediv" style="clear: both;">
					<p style="margin: 10px; text-align: center; ">
						<?php _e( 'If you like/dislike this theme, or if you encounter any issues using it, please let us know it.<br /><a href="http://www.twobeers.net/annunci/shiword" title="Shiword theme" target="_blank">Leave a feedback</a>' , 'tbqb' ); ?>
					</p>
				</div>
		</div>
	</div>
