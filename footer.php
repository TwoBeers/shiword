<!-- begin footer -->
		...
		<?php 
			...
			if ( ($shiword_opt['shiword_rsideb'] == 'true') ) if (!is_singular()) get_sidebar(); // show sidebar 
		?>
		<div id="footer">
			...
			<!-- Shiword theme v0.5 by TwoBeers Crew -->
		</div>
	</div>
											...
											<ul class="solid_ul">
												...
												<?php if ( ( is_user_logged_in() ) && current_user_can( 'read' ) ) {?>
													...
													<?php if ( current_user_can( 'publish_posts' ) ) { ?>
														<li><a title="<?php _e('Add New Post'); ?>" href="<?php echo admin_url('post-new.php'); ?>"><?php _e('Add New Post'); ?></a></li>
													<?php } ?>
													<?php if ( current_user_can( 'moderate_comments' ) ) { ?>
														<li><a title="<?php _e('Comments'); ?>" href="<?php echo admin_url('edit-comments.php'); ?>"><?php _e('Comments'); ?></a></li>
													<?php } ?>
												<?php } ?>
